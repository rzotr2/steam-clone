...
export default function NewItemContent() {
    return (
        <>
            <div className="flex px-4 pt-5 pb-3 gap-5 space-y-3 > li">
                <ul>
                    <li><TextElement text="POPULAR" variant="subtitle"
                    ...
                    <li className="mt-4"><TextElement text="NEWS & UPDATES" variant="subtitle"
                                                      additionalClasses="text-[#2ebfff] opacity-75 tracking-wider font-extrabold text-xs"/>
                    </li>
                ...
                <ul className="m-0 p-0">
                    <li><TextElement text="PROMOS & EVENTS" variant="subtitle"
                                     additionalClasses="text-[#2ebfff] opacity-75 tracking-wider font-extrabold text-xs"/>
                    </li>
