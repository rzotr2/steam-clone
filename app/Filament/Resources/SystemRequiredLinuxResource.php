...
use App\Filament\Resources\SystemRequiredLinuxResource\Pages;
use App\Filament\Resources\SystemRequiredLinuxResource\RelationManagers;
use App\Models\SystemRequiredLinux;
use Filament\Forms;
...
class SystemRequiredLinuxResource extends Resource
{
    protected static ?string $model = SystemRequiredLinux::class;
            ...
            ->schema([
                Section::make('Application')
                    ...
                    ->relationship('application', 'name', function ($query) {
                        return $query->whereHas('systems', fn ($q) => $q->where('name', 'Linux'));
                    })
                    ->searchable()
                    ->preload()
                    ->required(),
    ...
    {
        return [
            'index' => Pages\ListSystemRequiredLinuxes::route('/'),
            'create' => Pages\CreateSystemRequiredLinux::route('/create'),
            'view' => Pages\ViewSystemRequiredLinux::route('/{record}'),
            'edit' => Pages\EditSystemRequiredLinux::route('/{record}/edit'),
        ];
    }
}
